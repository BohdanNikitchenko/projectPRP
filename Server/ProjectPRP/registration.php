...
<form action="index.php" method="post" class="form-signin">
    ...
    <p><select id="selectSubj1"class="selectSubj" name="hero">
    ...
    <p><strongChoose Subject</strong></p>
    <p><select id="selectSubj2"class="selectSubj" name="hero">
            <option value="Украинский" selected>Украинский</option>
            <option value="Математика" >Математика</option>
            <option value="Английский">Английский</option>
            <option value="Физика">Физика</option>
    ...
    <p><strongChoose Subject</strong></p>
    <p><select id="selectSubj3" class="selectSubj" name="hero">
            <option value="Украинский" selected>Украинский</option>
            <option value="Математика" >Математика</option>
            <option value="Английский">Английский</option>
            <option value="Физика">Физика</option>
