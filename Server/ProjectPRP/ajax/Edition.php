...
$result = $mysql->query("UPDATE users SET Email='$email', Name='$name', SurName ='$SerName', ThierdName='$thirdname', PHONE='$phone', Subj1='$subj1',Subj2='$subj2', Subj3='$subj3', Subj1Mark='$Subj1Mark',Subj2Mark='$Subj2Mark',Subj3Mark='$Subj3Mark' WHERE Id ='$id';");
