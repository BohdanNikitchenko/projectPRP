        ...
        <div class="collapse navbar-collapse ml-5" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown ml-5 ">
                    <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ЗНО</a>
                ...
                <li class="nav-item">
                    <a class="nav-link ml-5" href="#">Спеціальності</a>
                </li>
                <li class="nav-item dropdown ml-5">
                    <a class="nav-link dropdown-toggle " href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ЗВО</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
